...
module.exports = function apiRoutes() {
    ...
    // ## Subscribers
    router.get('/subscribers', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.browse));
    router.get('/subscribers/csv', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.exportCSV));
    ...
    router.get('/subscribers/:id', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.read));
    router.get('/subscribers/email/:email', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.read));
    router.post('/subscribers', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.add));
    router.put('/subscribers/:id', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.edit));
    router.del('/subscribers/:id', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.destroy));
    router.del('/subscribers/email/:email', labs.subscribers, mw.authAdminAPI, api.http(api.subscribers.destroy));
